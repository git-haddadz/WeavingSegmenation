...
def u_net_non_binary(shape, nb_filters_0=32, exp=1, conv_size=3, initialization='glorot_uniform', activation="relu", activation_output="sigmoid", sigma_noise=0, output_channels=1, drop=0.0):
    """U-Net model.
    ...
    conv10 = Conv2D(output_channels, 1, activation=activation_output, name="conv_out")(conv9)
